...
public class AddAreaThree extends BaseView implements SetAreaManage.View{
    ...
    private void initViews() {
        ...
        adapter.addDeleteCallback(new DeleteCallback() {
            ...
            public void delete(int id, int position) {
                ...
                String token = SharedPreferencesUtil.Obtain(AddAreaThree.this, "token", "").toString();
                LoadingDialog dialog = LoadingDialog.build(AddAreaThree.this).setLoadingTitle("删除中");
                dialog.show();
