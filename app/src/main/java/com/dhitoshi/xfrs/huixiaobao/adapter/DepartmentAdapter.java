...
import com.dhitoshi.xfrs.huixiaobao.view.AddDepartment;
...
public class DepartmentAdapter extends BaseAdapter<KidBean> {
    private Context context;
    private DeleteCallback deleteCallback;
    public DepartmentAdapter(List<KidBean> mList, Context context) {
    ...
    public void covert(BaseRecyclerHolder holder, final List<KidBean> mList, final int position) {
        ...
        holder.getView(R.id.area_update).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, AddDepartment.class)
