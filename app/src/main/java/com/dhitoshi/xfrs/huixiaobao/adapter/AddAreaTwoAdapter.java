...
import com.dhitoshi.xfrs.huixiaobao.view.AddAreaThree;
...
public class AddAreaTwoAdapter extends BaseAdapter<KidBeanX> {
    private Context context;
    private DeleteCallback deleteCallback;
    public AddAreaTwoAdapter(List<KidBeanX> mList, Context context) {
        super(mList, context,  R.layout.area_item, 3);
        this.context=context;
    }
    @Override
    public void covert(BaseRecyclerHolder holder, final List<KidBeanX> mList, final int position) {
        ...
        holder.getView(R.id.are_main).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context,AddAreaThree.class)
