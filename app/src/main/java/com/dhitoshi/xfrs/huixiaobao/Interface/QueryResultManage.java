...
public interface QueryResultManage {
    ...
    interface Model{
        void getSearchOne(Map<String, String> map, SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<ClientBean>>> callback);
        void getSearchTwo(Map<String, String> map, SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<SpendBean>>> callback);
        void getSearchThree(Map<String, String> map, SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<VisitBean>>> callback);
        void getSearchFour(Map<String, String> map,SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<RelationBean>>> callback);
        void getSearchFive(Map<String, String> map, SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<GiftBean>>> callback);
        void getSearchSix(Map<String, String> map, SmartRefreshLayout smartRefreshLayout, Callback<HttpBean<PageBean<MeetBean>>> callback);
    }
    interface Presenter{
