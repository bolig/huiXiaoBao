...
public interface FastSignManage {
    interface View{
        void fastSign(String result);
        void getGroupLists(HttpBean<List<UserRole>> httpBean);
    }
    interface Model{
        void fastSign(Map<String, String> map, LoadingDialog dialog, Callback<HttpBean<Object>> callback);
        void getGroupLists(String token, Callback<HttpBean<List<UserRole>>> callback);
    }
    interface Presenter{
        void fastSign(Map<String, String> map, LoadingDialog dialog);
