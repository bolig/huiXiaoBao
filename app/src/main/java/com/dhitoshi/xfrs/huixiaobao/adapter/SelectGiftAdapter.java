...
public class SelectGiftAdapter extends BaseAdapter<GiftBean> {
    private CheckBoxClick click;
    private String selected;
    public SelectGiftAdapter(List<GiftBean> mList, Context context, String selected) {
    ...
    public void covert(BaseRecyclerHolder holder, final List<GiftBean> mList, final int position) {
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                click.check(true,mList.get(position).getGift(),mList.get(position).getId());
            }
        });
        if(selected.equals(mList.get(position).getGift())){
